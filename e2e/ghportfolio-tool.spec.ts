...
// 1x1 transparent png so the avatar never hits the network during tests.
...
const MOCK_USER = {
  ...
  avatar_url: AVATAR, html_url: "https://github.com/sindresorhus", blog: "https://sindresorhus.com",
  company: null, location: "Oslo", followers: 50000, public_repos: 1000, twitter_username: "sindresorhus",
};
const MOCK_REPOS = [
  { name: "ky", html_url: "https://github.com/sindresorhus/ky", description: "Tiny HTTP client", stargazers_count: 12000, language: "TypeScript", fork: false, archived: false, owner: { login: "sindresorhus" } },
  { name: "ow", html_url: "https://github.com/sindresorhus/ow", description: "Argument validation", stargazers_count: 3700, language: "TypeScript", fork: false, archived: false, owner: { login: "sindresorhus" } },
...
test.describe("github → portfolio tool", () => {
  test.beforeEach(async ({ page }) => {
    await page.route("**://api.github.com/**", (route) => {
      ...
      const body = url.includes("/repos") ? MOCK_REPOS : MOCK_USER;
  ...
  test("sample renders the portfolio with bio, stack and top repos", async ({ page }) => {
    ...
    await expect(page.locator("#result").getByText("Top projects")).toBeVisible();
