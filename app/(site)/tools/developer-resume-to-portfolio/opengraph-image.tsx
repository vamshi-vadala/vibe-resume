  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        {/* headline */}
        <div style={{ color: "#e7ecf2", fontSize: 72, fontWeight: 800, lineHeight: 1.1, marginBottom: 32, maxWidth: 940 }}>
          Developer Resume → Portfolio
        </div>
        {/* sub */}
        <div style={{ color: "#93a0b0", fontSize: 34, fontWeight: 400, lineHeight: 1.4, maxWidth: 820 }}>
          Your GitHub, projects and tech stack — pulled out automatically. Free.
        </div>
      </div>
    ),
    { ...size }
